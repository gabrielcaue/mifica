...
> Compatibilidade legada: o backend também aceita `MYSQLHOST`, `MYSQLPORT`, `MYSQLDATABASE`, `MYSQLUSER` e `MYSQLPASSWORD` enquanto um ambiente antigo ainda estiver em uso.
